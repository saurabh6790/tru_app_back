...
class DocType:
	...
	def assign_corrossive_sulphur_test(self):
		test_details = {'test': "Corrossive Sulphur", 'name': self.doc.name}
	...
	def on_submit(self):
		...
		if self.doc.workflow_state=='Rejected':
			...
			#for val in voltage:
			create_child_testresult(parent,self.doc.visual_observation,test_detail,'Corrossive Sulphur')
